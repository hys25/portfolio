        ...
        <div className="flex flex-col w-2/3 md:mb-4 md:m-full md:w-full">
          <div className="mb-8 pr-[150px] md:pr-0 md:text-[14px]">
            ...
            <p className="mb-4">
              ...
              design prototyping in the{" "}
              <span className="bg-greyDark">Figma</span>, planning system
              architecture and picking up web technological accordingly.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              <span className="bg-greyDark">Next.js</span> framework to benefit
              from server-side rendering features, rich optimization tools and
              simplisity of usage.
            </p>
            <p className="mb-4">
              For the dashboard I decided to go with a bare{" "}
              <span className="bg-greyDark">React</span> library for the UI
              layer, <span className="bg-greyDark">Redux + RTK Query</span> for
              the business logic layer. For styling I choosed modern
              utility-first <span className="bg-greyDark">Tailwind CSS</span>{" "}
              framework to be able to bootstrap dashboard UI in the efficient,
              scalable approach.
            </p>
            <p className="mb-4">
              On the server-side I setup{" "}
              <span className="bg-greyDark">Express.js</span> app with{" "}
              <span className="bg-greyDark">MongoDB database</span>
